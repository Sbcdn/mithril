...
mod tests {
    ...
    fn cardano_transaction_record(block_number: u64) -> SignedEntityRecord {
        use mithril_common::entities::{CardanoTransactionsSnapshot, SignedEntityType};
    ...
    fn cardano_blocks_transactions_record(block_number: u64) -> SignedEntityRecord {
        use mithril_common::entities::{
            BlockNumberOffset, CardanoBlocksTransactionsSnapshot, SignedEntityType,
        };
    ...
    async fn get_cardano_transaction_signed_entity_at_or_below_block_number_when_nothing_found() {
        ...
        let record = store
            .get_cardano_transaction_signed_entity_at_or_below_block_number(BlockNumber(100))
            .await
            .unwrap();
    ...
    async fn get_cardano_transaction_signed_entity_at_or_below_block_number_returns_highest_at_or_below()
     {
        ...
        let exact = store
            .get_cardano_transaction_signed_entity_at_or_below_block_number(BlockNumber(200))
            .await
            .unwrap();
        ...
        let below = store
            .get_cardano_transaction_signed_entity_at_or_below_block_number(BlockNumber(250))
            .await
            .unwrap();
        ...
        let none = store
            .get_cardano_transaction_signed_entity_at_or_below_block_number(BlockNumber(50))
            .await
            .unwrap();
        assert_eq!(None, none);
    }
    ...
    async fn get_cardano_blocks_transactions_signed_entity_at_or_below_block_number_returns_highest_at_or_below()
     {
        ...
        let exact = store
            .get_cardano_blocks_transactions_signed_entity_at_or_below_block_number(BlockNumber(
                200,
            ))
            .await
            .unwrap();
        ...
        let none = store
            .get_cardano_blocks_transactions_signed_entity_at_or_below_block_number(BlockNumber(50))
            .await
            .unwrap();
        assert_eq!(None, none);
    }
